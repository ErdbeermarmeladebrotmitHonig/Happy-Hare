...
class MmuMachine:
    ...
    def __init__(self, config):
        ...
        self.selector_type = config.getchoice('selector_type', {o: o for o in ['LinearSelector', 'LinearSelectorIdler', 'VirtualSelector', 'MacroSelector', 'RotarySelector', 'ServoSelector', 'IndexedSelector']}, selector_type)
...
class MmuKinematics:
    def __init__(self, toolhead, config):
        ...
        # Setup "axis" rails
        self.rails = []
        if self.mmu_machine.selector_type in ['LinearSelector', 'LinearSelectorIdler', 'RotarySelector']:
